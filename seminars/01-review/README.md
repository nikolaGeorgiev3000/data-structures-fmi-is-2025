# СД на ИС – семинар – група 1 – седмица 1

## Задачи за преговор на материала от миналата година

### Задача 1
Напишете шаблонна функция `swap`, която разменя двата си параметъра:
- a) като получава указатели към тях;
- b) като получава референции към тях.

---

### Задача 2
Напишете функция `readCString`, която чете от входен поток дължина на низ, след което заделя динамична памет за него, чете го от входния поток, и го връща.  
...
### Задача 5
Генерирайте всички **вариации без повторение** от *k*-ти клас на *n*-елементно множество.
