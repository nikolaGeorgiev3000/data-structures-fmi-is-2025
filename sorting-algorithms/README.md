...
Below is a compact comparison table of the main sorting algorithms used in the course:

| Algorithm       | Best Case | Average Case | Worst Case | Space Complexity | Stable | Adaptive | Note |
|-----------------|-----------|--------------|------------|------------------|--------|----------|------|
| **Bubble Sort**    | Θ(n)      | Θ(n²)         | Θ(n²)       | O(1)             | Yes    | Yes      | Minimizes the number of swaps |
| **Selection Sort** | Θ(n²)     | Θ(n²)         | Θ(n²)       | O(1)             | No     | No       | — |
